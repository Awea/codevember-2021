...
const preload = (p5) => {
  cheeseImg = p5.loadImage('assets/15/cheese.png')
  ...
  class Boid {
    constructor(x, y) {
      ...
      this.cheeseWidth = this.r * 10
      this.cheeseHeight = this.r * 5
    ...
    render() {
      ...
      p5.rotate(theta)
      // p5.scale(0.2)
      p5.image(cheeseImg, 0, 0, this.cheeseWidth, this.cheeseHeight)
      p5.pop()
    }
    ...
    borders() {
      if (
        this.position.x <= -this.cheeseWidth ||
        this.position.x > p5.width + this.cheeseWidth
      )
        this.velocity.x = this.velocity.x * -1
      if (
        this.position.y <= -this.cheeseHeight ||
        this.position.y > p5.height + this.cheeseHeight
      )
